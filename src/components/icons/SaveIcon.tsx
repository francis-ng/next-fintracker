function SaveIcon({width, height}: {width: number, height: number}) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor" className="bi bi-cloud-upload" viewBox="0 0 16 16">
